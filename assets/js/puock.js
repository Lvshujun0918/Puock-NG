...
class Puock {
    ...
    onceInit() {
        ...
        console.log("\n %c Puock Theme 增强版 %c https://github.com/Lvshujun0918/Puock-NG/ \n\n",
    ...
    validateInit() {
        if (this.data.params.vd_type === 'gt' && !this.data.params.is_home) {
            initGeetest4({
    ...
    initCodeHighlight(fullChange = true, bodyEl="body") {
        if(this.data.params.off_code_highlighting || this.data.params.is_home){
            return
        }
