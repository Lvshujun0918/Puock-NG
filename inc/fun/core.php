...
//已优化，如果要自定义链接记得改回来 TODO
//静态资源加载源的链接
function pk_get_static_url()
{
    // do_action( 'qm/start', 'pk_get_static_url' );
    ...
    // }
    // do_action( 'qm/stop', 'pk_get_static_url' );
    return PUOCK_ABS_URI;
}
